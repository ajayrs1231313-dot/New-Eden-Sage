...
// Logs deliberately live with Electron userData rather than the bulk data drive.
// If the external/legacy data drive stalls, diagnostics must remain writable.
