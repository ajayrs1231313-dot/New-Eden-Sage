...
contextBridge.exposeInMainWorld("sage", {
  ...
  getContractMarketWorkspace: () => ipcRenderer.invoke("market:contract-workspace"),
  searchMarketContracts: (input:unknown) => ipcRenderer.invoke("market:contract-search", input),
  ...
  submitCorporationHrSnapshot: (input:unknown) => ipcRenderer.invoke("corp:hr-submit-snapshot", input),
  withdrawCorporationHrRequest: (code:string) => ipcRenderer.invoke("corp:hr-withdraw", code),
  addCorporationHrNote: (input:unknown) => ipcRenderer.invoke("corp:hr-note", input),
  setCorporationHrDecision: (input:unknown) => ipcRenderer.invoke("corp:hr-decision", input),
  ...
  getFitterContentConfig: () => ipcRenderer.invoke("fitting:content-config"),
