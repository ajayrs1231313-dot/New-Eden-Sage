        ...
        content: [
          {
            ...
            shipRoutes: [
              { shipClass: "Frigate", roles: ["Damage / combat"], ships: ["Rifter", "Tristan", "Kestrel", "Punisher", "Merlin", "Incursus", "Breacher", "Tormentor", "Hookbill", "Comet", "Firetail", "Slicer"] },
        ...
        content: [
          {
            ...
            shipRoutes: [
              { shipClass: "Frigate", roles: ["Line DPS"], ships: ["Harpy", "Retribution", "Wolf", "Enyo", "Hookbill", "Comet"] },
    ...
    subcategories: [
      {
        ...
        content: [
          ...
          },
          {
            ...
            supportSkills: [{ skill: "Invention", level: 4 }, { skill: "Supply Chain Management", level: 4 }, { skill: "Accounting", level: 4 }],
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            coreSkills: [{ skill: "Science", level: 5 }, { skill: "Invention", level: 4 }],
            supportSkills: [{ skill: "Laboratory Operation", level: 5 }, { skill: "Advanced Laboratory Operation", level: 4 }],
        ...
        content: [
          {
            ...
            description: "Frigate and destroyer-focused FW with frequent engagements and low replacement cost.",
            difficulty: "Intermediate",
            experience: "Basic solo PvP skills and willingness to learn matchups through repeated fights.",
            ships: ["Tristan", "Kestrel", "Firetail", "Hookbill", "Comet", "Thrasher"],
            coreSkills: [...core.fitting, ...core.navigation],
          ...
          {
            id: "fw-medium-large",
            label: "Medium / large complexes",
            description: "Cruiser and battlecruiser FW where fleet composition, projection and tackle become more important.",
            difficulty: "Advanced",
            experience: "Comfortable with small-gang communication, target calling and disengagement.",
            ships: ["Caracal", "Omen", "Vexor", "Stabber", "Hurricane", "Drake"],
            coreSkills: [...core.fitting, ...core.navigation],
          ...
          },
          {
            id: "fw-battlefields",
            label: "Battlefields",
            description: "Larger organized FW objectives with stronger fleet and logistics expectations.",
            difficulty: "Advanced",
            experience: "Fleet experience and a doctrine-ready combat or logistics ship.",
            ships: ["Ferox", "Hurricane", "Scimitar", "Basilisk", "Guardian"],
